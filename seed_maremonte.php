<?php
/**
 * Hotel Mare & Monte Bistro Complete Menu Seeder (All 14 Categories & 123 Items)
 */
...
try {
    ...
    // Drop and re-create tables cleanly
    ...
    echo "Tablolar sıfırdan hazırlandı.\n";
    ...
    $settings = [
        ...
        // MODÜL AÇ/KAPA
        'enable_order' => '0',            // Masadan Doğrudan Sipariş Pasif (Garson Çağrısı Aktif)
        ...
        'popup_desc' => '1985\'ten beri Altınoluk sahilinde eşsiz lezzetler, taze deniz ürünleri ve imza kokteyllerimizi keşfedin!',
        'popup_image' => 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=80',
        'popup_btn_text' => 'İmza Kokteylleri İncele',
        'popup_btn_link' => '#cat-13',
    ...
    // 4. Stories
    $stories = [
        ['title' => 'İmza Kokteyller', 'image' => 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=600&q=80', 'link' => '#cat-13', 'sort_order' => 1],
        ['title' => 'Taze Balıklar', 'image' => 'https://images.unsplash.com/photo-1519708227418-c8fd9a32b7a2?w=600&q=80', 'link' => '#cat-8', 'sort_order' => 2],
        ['title' => 'Bonfile & Lokum', 'image' => 'https://images.unsplash.com/photo-1558030006-450675393462?w=600&q=80', 'link' => '#cat-7', 'sort_order' => 3],
        ['title' => 'Taş Fırın Pizza', 'image' => 'https://images.unsplash.com/photo-1604382355076-af4b0eb60143?w=600&q=80', 'link' => '#cat-4', 'sort_order' => 4],
        ['title' => 'Soğuk Kahveler', 'image' => 'https://images.unsplash.com/photo-1517701550927-30cf4ba1dba5?w=600&q=80', 'link' => '#cat-10', 'sort_order' => 5],
        ['title' => 'Buz Gibi Biralar', 'image' => 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=600&q=80', 'link' => '#cat-11', 'sort_order' => 6],
    ];
    ...
    // 6. Örnek Yorumlar
    $feedbacks = [
        ['table_number' => '4', 'rating' => 5, 'name' => 'Ahmet Kaya', 'comment' => 'Bonfile lokum, karides güveç ve Aegean Bloom kokteyl tek kelimeyle muhteşemdi! Altınoluk\'un en iyi yeri.'],
        ['table_number' => 'I2', 'rating' => 5, 'name' => 'Selin Yılmaz', 'comment' => 'İskelede gün batımı eşliğinde taze levrek, kalamar ve soğuk bira harikaydı, servis çok hızlı.'],
        ['table_number' => 'B1', 'rating' => 5, 'name' => 'Mehmet Öz', 'comment' => 'Mare Burger, pizzalar ve buz gibi ev yapımı limonata çok lezzetli, bayıldık.'],
        ['table_number' => 'T1', 'rating' => 5, 'name' => 'Canan D.', 'comment' => 'Whiskey Sour ve San Sebastian cheesecake harika bir ikili oldu. Manzara ve müzikler çok kaliteli.']
    ];
    ...
    echo "TAMAMLANDI: Hotel Mare & Monte Bistro menüsünün tüm 14 kategorisi ve 121 ürünü başarıyla kuruldu!\n";
